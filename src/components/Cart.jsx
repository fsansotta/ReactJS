...
function Cart() {
    ...
    const handleClickDos = (id) => {
        ...
        return (<div>{items.map(item =>
            ...
            <section className="totalDetail">
                <p >TOTAL DE SU COMPRA: $ {calcularTotalCompra()} </p>
                <div>
                    <button style={{marginLeft: "5px",marginRight: "5px"}} type="button" class="btn btn-danger" onClick={handleClick}>VACIAR CARRITO</button>
    ...
    return (
        <div>
            <p className="carritoVacio"> No tienes productos seleccionados</p>
        </div>
    )
}
